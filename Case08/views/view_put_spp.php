				...
				<table class="table table-hover table-dark">
					...
					?>
						...
						<form action="../config/routes.php?function=put_spp" method="POST">
							...
							<tr>
								<td>TAHUN</td>
								<td><input type="text" class="form-control" name="tahun" value="<?php echo $Get['tahun'] ?>"></td>
							</tr>

							<tr>
								<td>NOMINAL</td>
								<td><input type="text" class="form-control" name="nominal" value="<?php echo $Get['nominal'] ?>"></td>
							</tr>


							<tr>
								<td><a class="btn btn-danger" href="...views/view_spp.php">back</a></td>
